...
def cleanup_and_tune():
    print_header("1. PERSIAPAN: BERSIH-BERSIH & TUNING")
    ...
    # 2. Hapus Socket (CRITICAL FIX)
    print_warn("Menghapus socket sampah (/tmp)...")
    # Tanda bintang (*) penting agar msc_mncc DAN msc_mncc_lan terhapus
    os.system("rm -f /tmp/pcu_bts* /tmp/osmocom_* /tmp/msc_mncc*")
